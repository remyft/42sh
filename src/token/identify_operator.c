...
/*   Updated: 2018/12/12 12:40:07 by gbourgeo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	static t_ope	ope[] = {
		OR_IF, PIPE, PIPE_AND, NOT, AND_IF, BACKGRND, SEMI, DSEMI, LESS,
		LESSAND, LESS_GREAT, GREAT, GREAT_PIPE, AND_GREAT, GREAT_AND, DGREAT,
		AND_GREAT, DGREAT_AND, DLESS, TLESS
	};
	size_t			i;
